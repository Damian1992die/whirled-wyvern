    ...
    implements Klass
{
    ...
    {
	  return [ WyvernConstants.TRAIT_REGEN ];
    }

    public function getMultiplier (itemType :int) :Number
    {
        switch (itemType) {
            case Items.BOW:  return 1.7;
		case Items.CLUB: case Items.AXE: case Items.LIGHT:  return 1.3;
		case Items.NONE:  return 1.0;
            case Items.ARCANE: case Items.MAGIC: return 0.9;
		case Items.HEAVY: case Items.SWORD: case Items.SPEAR:  return 0.5;
        }
        return 1;
    }
