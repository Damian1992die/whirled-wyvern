    ...
    implements Klass
{
    ...
    {
	  return [ WyvernConstants.TRAIT_PARRY ];
    }

    public function getMultiplier (itemType :int) :Number
    {
        switch (itemType) {
            case Items.HEAVY:  return 1.8;
		case Items.AXE: case Items.SPEAR:  return 1.4;
            case Items.LIGHT: case Items.SWORD:  return 1.2;
            case Items.CLUB: case Items.ARCANE: case Items.MAGIC: case Items.BOW:  return 1.0;
        }
        return 1;
    }
