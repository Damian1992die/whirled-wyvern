    ...
    implements Klass
{
    ...
    {
	  return [ WyvernConstants.TRAIT_BLOODTHIRST ];
    }

    public function getMultiplier (itemType :int) :Number
    {
        switch (itemType) {
            case Items.CLUB: case Items.AXE: case Items.SWORD: case Items.SPEAR:  return 2.5;
            case Items.LIGHT: case Items.BOW:  return .9;
		case Items.NONE:  return .6;
            case Items.HEAVY: case Items.ARCANE: case Items.MAGIC: return 0.4;
        }
        return 1;
    }
